...
namespace Testaus
{
    ...
    public class MatikkaUnitTest1
    {
        ...
        public void Lista_Pieninluku_EtsiiDesimaaliLuvun_PalauttaaListanPienimm‰nLuvun(double[] lista, double tulos)
        {
        ...
        [TestMethod]
        [DataRow(new double[] { 3.14, 2.718, 1.414 }, 1.414)]
        public void Lista_SuurinLuku_EtsiiDesimaaliLuvun_PalauttaaListanPienimm‰nLuvun(double[] lista, double tulos)
        {
            double odotettuTulos = Laskin.Lista(lista.ToList());
